...
- A translucent visual locality band distinguishes service types rather than claiming exact electrical reach. SCL uses a tight ~30 km band and the strongest centre-circle emphasis, Voltage uses a regional ~60 km band with slightly smaller emphasis, and Inertia uses a wider ~100 km band with the quietest centre-circle emphasis.
